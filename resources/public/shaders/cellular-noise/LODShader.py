# Terrain LODShader by benj,
#
# Have fun with this, feel free to use it, share it, improve it
# Tutorial and discussion in the blenderartist thread
# 
# Feel free to contact me as well: benjamin_vedrenne[at]homail.com
...
own.localPosition[0] = int(player.localPosition[0]/cell)*cell
own.localPosition[1] = int(player.localPosition[1]/cell)*cell

own['uvX']=(int(player.localPosition[0]/cell))
own['uvY']=(int(player.localPosition[1]/cell))
...
for mat in mesh.materials:
	...
	if shader != None:
		...
		shader.setSampler('multilayer',1)
		shader.setSampler('stencil',2)		
		shader.setSampler('lightmap',3)
		shader.setUniform1i('uvX',own["uvX"])
		shader.setUniform1i('uvY',own["uvY"])
